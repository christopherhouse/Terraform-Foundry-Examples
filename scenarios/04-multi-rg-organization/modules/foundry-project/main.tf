...
resource "azapi_resource" "project" {
  ...
  body = {
    properties = {
      displayName = "Scenario 04 Multi-RG Foundry (${var.environment})"
      description = "Network-isolated Foundry project with VNet-injected Standard Agent and BYO Cosmos/Storage/Search, split across network/data/AI/observability RGs."
    }
  }
